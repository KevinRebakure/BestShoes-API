package com.rebakure.bestshoes.config.kafka;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, CheckoutEvent> consumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, CheckoutEvent.class.getName());
    ...
    public ConcurrentKafkaListenerContainerFactory<String, CheckoutEvent> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, CheckoutEvent> factory =
